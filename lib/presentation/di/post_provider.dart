import 'package:book_story/data/repos/post_repo_impl.dart';
import 'package:book_story/data/services/post_service.dart';
import 'package:book_story/domain/repository/post_repo.dart';
import 'package:book_story/domain/use_cases/post/add_post_use_case.dart';
import 'package:book_story/domain/use_cases/post/add_post_use_case_impl.dart';
...
import 'package:book_story/domain/use_cases/post/get_all_post_use_case_impl.dart';
import 'package:book_story/domain/use_cases/post/get_user_by_user_id.dart';
import 'package:book_story/domain/use_cases/post/get_user_by_user_id_impl.dart';
import 'package:book_story/domain/use_cases/post/update_post_use_case.dart';
import 'package:book_story/domain/use_cases/post/update_post_use_case_impl.dart';
import 'package:book_story/presentation/di/book_component.dart';
...
import 'package:book_story/presentation/view_models/post/add_post_view_model.dart';
import 'package:book_story/presentation/view_models/post/delete_post_view_model.dart';
import 'package:book_story/presentation/view_models/post/post_detail_view_model.dart';
